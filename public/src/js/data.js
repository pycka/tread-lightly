define(['components/Map', 'components/World'], function (Map, World) {
    ...
    var data = window.data = {
        ...
        loadSounds: function(){
            this.sounds.background = new buzz.sound("/sounds/DST-3rdBallad.ogg", {
                preload: true,
                autoplay: false,
                loop: true
            });
            this.sounds.heartBeat = new buzz.sound("/sounds/Slow_HeartBeat-Mike_Koenig-1853475164_strong.ogg", {
                preload: true,
                autoplay: false,
                loop: false
            });
